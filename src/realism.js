...
import { DataTexture, RGBAFormat, FloatType, ShaderChunk, ShaderLib, UniformsUtils, WebGLMultipleRenderTargets, ShaderMaterial, GLSL3, Uniform, Vector2, Matrix4, Vector3, Clock, Quaternion, LinearFilter, HalfFloatType, NearestFilter, WebGLRenderTarget, ClampToEdgeWrapping, LinearMipMapLinearFilter, EquirectangularReflectionMapping, Color, Matrix3, TangentSpaceNormalMap, RepeatWrapping, RedFormat, MeshDepthMaterial, RGBADepthPacking, BackSide, TextureLoader, LinearEncoding, DepthTexture, sRGBEncoding, Texture, NoToneMapping, PerspectiveCamera, UnsignedByteType, FramebufferTexture } from 'three';
